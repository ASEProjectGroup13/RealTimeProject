...
public class ServerToReceiveAudioData {
	public static String DataTrainingPath = "data/data/genres/training/";
	public static String DataTestingPath = "data/data/genres/testing/";

//    public static String DataTrainingPath = "src/main/resources/data/data/genres/training";
//    public static String DataTestingPath = "src/main/resources/data/data/genres/testing";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            while (true) {
                ...
                File file = new File("data/data/genres/testing/blues/"+name);
                ...
                String genre=classify(trainingInstances,file);
    ...
    public static String genreClassify(String name) throws Exception
    {
    	String[] split = name.split("."); //Change logic accordingly what you receive 
    	// I assumed, I will get filename which is like classical.0001.au // As I need classical

       // String filePath = "\"data/data/genres/testing/\" +split+\"/\"+name"
